...
//	frequenciartd++;
	...
	{  // envio da mensagem no can
		...
		HAL_GPIO_WritePin(GPIOB, GPIO_PIN_10, GPIO_PIN_SET); //só pra teste de ligar o led

	}
		else { HAL_GPIO_WritePin(GPIOB, GPIO_PIN_10, GPIO_PIN_RESET); //só pra teste de ligar o led
		btn_apertado = 0;
